...
namespace Company.ChestGame.Pooling.Demo
{
    ...
    // transform a race parents placed instances under. The pool already carries its own holder, or
    // none at all for the baseline, so a lane needs nothing more than this to fill independently.
